...
本工程用于联调优酷定制 iOS SDK `6.3.6` 的自渲染广告。示例使用公开模块 `IFLYADLib`，安装包名称为 `YKIFLYADLib`，最低支持 iOS 11.0。完整安装方式与 SDK API 说明见[仓库 README](../README.md)。

> 当前示例对应公开正式版 [`6.3.6`](https://github.com/LJMcarryu/YKIFLYADLib_iOS/releases/tag/6.3.6)，包含 UIScene 展示、落地页、外跳回流、曝光和 UI 生命周期适配。
