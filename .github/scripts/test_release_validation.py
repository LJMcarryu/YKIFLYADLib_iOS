...
class RequestBoundaryTests(unittest.TestCase):
    ...
    def test_anonymous_request_never_has_authorization(self) -> None:
        request = anonymous.build_anonymous_request(
            "https://api.github.com/repos/owner/repo/releases/tags/6.3.2",
...
class PrivateProvenanceDocumentTests(unittest.TestCase):
    ...
    def test_formal_current_section_ignores_historical_formal_section(self) -> None:
        document = provenance_section(
            "6.3.2 发布状态", "FORMAL", BINARY_COMMIT, METADATA_COMMIT
        ) + provenance_section("6.3.1", "FORMAL", "a" * 40, "b" * 40)
        self.assertEqual(
            private_provenance.parse_document(document, "测试文档"),
...
class WorkflowStructureTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.current_closed_state.update({"version": "6.3.2", "phase": "CLOSED"})
    ...
    def test_repository_and_release_modes_accept_only_exact_state_matrix(self) -> None:
        previous_closed = {"version": "6.3.1", "phase": "CLOSED"}
        current_closed = {"version": "6.3.2", "phase": "CLOSED"}
        current_frozen = {"version": "6.3.2", "phase": "FROZEN"}
        ...
        for state, kind in (
            ...
            ({"version": "6.3.2", "phase": "PREPARING"}, "draft"),
            ({"version": "6.3.2", "phase": "PUBLISHED"}, "draft"),
            ({"version": "6.3.2", "phase": "VERIFIED"}, "formal"),
            ({"version": "6.3.2", "phase": "CLOSED"}, "formal"),
            ({"version": "6.3.2", "phase": "FROZEN"}, "none"),
            ({"version": "6.3.2", "phase": "PREPARING"}, "none"),
            ({"version": "6.3.2", "phase": "PUBLISHED"}, "none"),
            ({"version": "6.3.2", "phase": "VERIFIED"}, "none"),
        ):
