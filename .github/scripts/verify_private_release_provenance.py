...
CURRENT_RELEASE_VERSION = "6.3.7"
PENDING_BINARY = "__IFLYADLIB_YOUKU_6_3_7_BINARY_SOURCE_COMMIT_PENDING__"
PENDING_METADATA = "__IFLYADLIB_YOUKU_6_3_7_RELEASE_METADATA_COMMIT_PENDING__"
...
def has_public_release_status(document: str) -> bool:
    ...
    return marker == {
        ...
        "releaseUrl": "https://github.com/LJMcarryu/YKIFLYADLib_iOS/releases/tag/6.3.7",
    }
