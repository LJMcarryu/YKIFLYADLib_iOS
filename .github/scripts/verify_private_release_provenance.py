#!/usr/bin/env python3
"""Verify formal Youku release provenance against the private source repository."""
...
CURRENT_RELEASE_VERSION = "6.3.6"
PENDING_BINARY = "__IFLYADLIB_YOUKU_6_3_6_BINARY_SOURCE_COMMIT_PENDING__"
PENDING_METADATA = "__IFLYADLIB_YOUKU_6_3_6_RELEASE_METADATA_COMMIT_PENDING__"
...
def has_public_release_status(document: str) -> bool:
    ...
    return marker == {
        ...
        "releaseUrl": "https://github.com/LJMcarryu/YKIFLYADLib_iOS/releases/tag/6.3.6",
    }
