...
PENDING_BINARY = "__IFLYADLIB_YOUKU_6_4_0_BINARY_SOURCE_COMMIT_PENDING__"
PENDING_METADATA = "__IFLYADLIB_YOUKU_6_4_0_RELEASE_METADATA_COMMIT_PENDING__"
...
def has_public_release_status(document: str) -> bool:
    ...
    return marker == {
        ...
        "releaseUrl": "https://github.com/LJMcarryu/YKIFLYADLib_iOS/releases/tag/6.4.0",
    }
